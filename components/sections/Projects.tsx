          ...
          {projects.map((project, index) => (
            ...
            >
              <Card className="h-full group relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-accent-primary/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
              </Card>
            </motion.div>
          ))}
        </div>
